...
CH_fixweight=100;SN_fixweight=500;
%%
%%*********************************************************************%%
airnum=1;%定义一个区域
...
uav_consume/uav_m-uav_gain/GS_weight+battle_ability/GS_weight+hive.lost/(hive_init.value)%+(sensor_add-sensor_lost)/10000-buildcost;
%%*********************************************************************%
%%所有相关参数
