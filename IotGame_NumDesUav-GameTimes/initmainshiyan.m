...
%%*********************************************************************%
hive_payoff=hive_payoff+hive_payoff_before_0;
iobt_payoff=iobt_payoff+iobt_payoff_before_0;
...
uavalllost=[uavalllost uav_consume];
%%*********************************************************************%
%%
[hive_payoff_before_0,iobt_payoff_before_0] = iobtchose(hive,subnum,subwight,subair,uav_m,time_druing,neednum,subairnum,P,UAV_totalnum,GS_weight);
%%*********************************************************************%
%%
end
for i=1:1:length(uavalllost)-1
uavalllost(i+1)=uavalllost(i)+uavalllost(i+1);
end
x=1:1:15;
plot(x,uavalllost(1:length(uavalllost)),'-b*','linewidth',2,'color',[118 111 253]/255);hold on
